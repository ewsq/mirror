...
public class AccountBindAdapter extends BaseQuickAdapter<AccountBindBean.DataBean, BaseViewHolder> {

    public AccountBindAdapter(int layoutResId, @Nullable List<AccountBindBean.DataBean> data) {
