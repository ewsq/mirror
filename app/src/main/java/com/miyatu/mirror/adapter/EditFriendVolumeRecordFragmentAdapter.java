...
public class EditFriendVolumeRecordFragmentAdapter extends BaseQuickAdapter<FriendVolumeRecordFragmentBean.DataBean, BaseViewHolder> {

    public EditFriendVolumeRecordFragmentAdapter(int layoutResId, @Nullable List<FriendVolumeRecordFragmentBean.DataBean> data) {
