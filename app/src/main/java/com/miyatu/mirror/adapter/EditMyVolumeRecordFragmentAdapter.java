...
public class EditMyVolumeRecordFragmentAdapter extends BaseQuickAdapter<MyVolumeRecordFragmentBean.DataBean, BaseViewHolder> {

    public EditMyVolumeRecordFragmentAdapter(int layoutResId, @Nullable List<MyVolumeRecordFragmentBean.DataBean> data) {
        super(layoutResId, data);
    }

    @Override
    protected void convert(BaseViewHolder helper, MyVolumeRecordFragmentBean.DataBean item) {
        ...
        Glide.with(mContext).load(item.isSelect() == true? R.mipmap.selected : R.mipmap.unselected).into(ivSelect);
        ...
        ChildAdapter childAdapter = new ChildAdapter(R.layout.item_item_my_volume_record_fragment, item.getMeasure());
    ...
    class ChildAdapter extends BaseQuickAdapter<MyVolumeRecordFragmentBean.DataBean.MeasureBean, BaseViewHolder> {

        public ChildAdapter(int layoutResId, @Nullable List<MyVolumeRecordFragmentBean.DataBean.MeasureBean> data) {
            super(layoutResId, data);
        }

        @Override
        protected void convert(BaseViewHolder helper, MyVolumeRecordFragmentBean.DataBean.MeasureBean item) {
