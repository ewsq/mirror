...
public class MyVolumeRecordFragmentAdapter extends BaseQuickAdapter<MyVolumeRecordFragmentBean.DataBean, BaseViewHolder> {

    public MyVolumeRecordFragmentAdapter(int layoutResId, @Nullable List<MyVolumeRecordFragmentBean.DataBean> data) {
