...
import com.miyatu.mirror.adapter.EditMyVolumeRecordFragmentAdapter;
...
public class EditMyVolumeRecordFragment extends PublicFragment implements HttpOnNextListener {
    ...
    private EditMyVolumeRecordFragmentAdapter adapter;
    ...
    protected int getLayout() {
        return R.layout.frag_edit_my_volume_record;
    }
    ...
    protected void initEvent() {
        ivSelectAll.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
               List<MyVolumeRecordFragmentBean.DataBean> dataBeanList = (List<MyVolumeRecordFragmentBean.DataBean>) adapter.getData();
               if (isSelectAll == true) {
                   isSelectAll = false;
    ...
    private void initRecyclerView() {
        adapter = new EditMyVolumeRecordFragmentAdapter(R.layout.item_edit_my_volume_record, null);
        ...
        adapter.setOnItemChildClickListener(new EditMyVolumeRecordFragmentAdapter.OnItemChildClickListener() {
            @Override
